...
2. If you already have the latest Release (ZIP), you can find the data file(s) and dll(s) in there
    ...
    - Navigate into the `MelissaProfilerObjectWindowsCpp` project folder, create a folder named `Build`, and copy all the dll(s) mentioned above into the `Build` folder.
    - Copy all the dependencies mentioned above into the `MelissaProfilerObjectWindowsCpp` project folder.
